...
<form action="filmlog" method="post">
<input type="text" id="filmauid" name="filmauid"><br>
<input type="password" id="filmpass" name="filmpass"><br>

<button class="flm">View Film Details</button>
</form>
<br><br><br><br><br><br><br><br><br>
<!--Footer-->
    <div className="ft">
